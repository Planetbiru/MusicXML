...
class MusicXMLBuilder
{
    ...
    /**
     * Recursively creates a DOMNode representation of this MusicXML object.
     *
     * This method iterates through the object's properties, creating corresponding
     * XML elements and attributes based on annotations. It handles nested objects
     * and arrays of objects by calling `toXml` on them recursively.
     *
     * @param DOMDocument $domdoc The parent DOMDocument to which the new nodes will belong.
     * @param string|null $name   The tag name for the root element of this object. If null, it's auto-detected from annotations.
     * @return DOMNode            The generated DOMNode for this object.
     */
